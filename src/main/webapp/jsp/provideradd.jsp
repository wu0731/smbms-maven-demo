...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post"
                 action="${pageContext.request.contextPath }/ProviderAdd" enctype="multipart/form-data">
			<input type="hidden" name="method" value="add">
               ...
               <div>
                   <input type="hidden" id="errorinfos" value="${uploadFileError}"/>
                   <label for="a_idPicPath">证件照：</label>
                   <input type="file" name="a_idPicPath" id="a_idPicPaths">
                   <font color="red"></font>
               </div>
