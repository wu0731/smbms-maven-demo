...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/userCon/userQuery">
			...
			<div class="providerView" hidden>
					<p><strong>用户编号：</strong><span id="userCode">${user.userCode }</span></p>
					<p><strong>用户名称：</strong><span id="userName">${user.userName }</span></p>
					<p><strong>用户性别：</strong>
						<span id="userGender">
				</span>
					</p>
					<p><strong>出生日期：</strong><span id="userBirthday">${userBirthday}</span></p>
					<p><strong>用户电话：</strong><span id="userPhone">${user.phone }</span></p>
					<p><strong>用户地址：</strong><span id="userAddress">${user.address }</span></p>
					<p><strong>用户角色：</strong><span id="userRoleName">${user.userRoleName}</span></p>
				</div>
